...
Pour la plupart des exemples, le C, représenté par «C.py», sera le code «Hello, World!» voir Listing ~\ref{lst:hello_world}.

\begin{lstlisting}[language=Python, caption={Exemple de code Hello, World!}, label={lst:hello_world}]
print("Hello, World!")
\end{lstlisting}
