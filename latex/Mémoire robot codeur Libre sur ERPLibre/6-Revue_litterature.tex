...
C’est un concept qui permet à l’utilisateur de développer une plateforme ou des bouts d'application en utilisant pas ou peu de code.

Selon l'auteur Bock.A.C de l'article «Low-Code Platform»~\cite{LC_bock_2021}, le LCNC a besoin de : 
\begin{enumerate}
    \item Aspect général;
    \begin{enumerate}
...
Selon l'auteur Apurvanand.S de l'article «Supporting the understanding and comparison of low-code development platform»~\cite{9226356}, il faut les éléments techniques suivants pour supporter une plateforme LCNC :
\begin{enumerate}
