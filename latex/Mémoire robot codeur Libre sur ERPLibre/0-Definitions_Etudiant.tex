...
\newcommand\monTitre{Robot logiciel développeur en amélioration continue : application à l’implantation d’un réseau d’entraide avec un ERP libre}
...
\newcommand\mesMotsClef{Générateur,code,rétro-ingénierie,amélioration continue,autopoïèse,allopoïèse,technopoïèse,odoo,erp,libre}
%%
