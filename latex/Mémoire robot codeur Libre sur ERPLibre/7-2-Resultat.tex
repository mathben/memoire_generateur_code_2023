...
L’intérêt de passer par Odoo pour lire le module est qu'i valide déjà certains fonctionnements (par exemple : pas d’erreur de syntaxe dans le Python où les XML étaient bien construits).
...
%todomarie elle est oû la figure 4.1?
...
\subsection{Sécurité}
%todomarie ce qui n'est pas clair ici c'est est-ce que c'est fait? C'est à faire? C'est quoi le lien avec le mémoire
...
%todomarie je ne comprends pas ce que ce bout de texte fait là. C'est un peu mal expliqué.
